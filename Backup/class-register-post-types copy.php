...
class Register_Post_Types {
	...
	/**
	 * Register the legacy products post type for backward compatibility.
	 *
	 * Existing content may still be stored with the historic `products` key.
	 * Keep it queryable inside the theme while routing all new content to
	 * the canonical `product` post type.
	 *
	 * @return void
	 */
	public function worthio_register_legacy_product_cpt() {
		$args = [
			'label'               => __( 'Legacy Products', 'worthio' ),
			'public'              => false,
			'show_ui'             => true,
			'show_in_menu'        => false,
