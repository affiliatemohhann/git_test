...
<div id="primary">
	<main id="main" class="site-main container mt-5" role="main">
		<deals365-search class="deals365-search row px-4">
			<Deals365-filters class="col-lg-3 col-md-3 col-sm-12 pb-4">
				<deals365-clear-all-filters class="clear-all-filters"><button class="btn btn-secondary">Clear All filters</button></deals365-clear-all-filters>
				<?php foreach ( $filters_data as $filter_data ) : ?>
					<deals365-checkbox-accordion
						...
						<deals365-checkbox-accordion-content class="checkbox-accordion__content">
							<?php foreach ( $filter_data['children'] as $item ) : ?>
								...
								<?php if ( ! empty( $item['label'] ) ) : ?>
									<deals365-checkbox-accordion-child class="checkbox-accordion__child <?php echo esc_attr( $has_content_class ); ?>">
											...
											<div class="checkbox-accordion__child-content">
												<?php foreach ( $item['children'] as $child ) : ?>
													...
													<?php if ( ! empty( $child['label'] ) && ! empty( $child['value'] ) ) : ?>
														<deals365-checkbox-accordion-child class="checkbox-accordion__child">
															<div class="checkbox-accordion__child-handle form-field">
																	...
																	<?php foreach ( $child['children'] as $grand_children ) : ?>
																		...
																		<?php if ( ! empty( $grand_children['label'] ) && ! empty( $grand_children['value'] ) ) : ?>
																			<deals365-checkbox-accordion-child class="checkbox-accordion__child <?php echo esc_attr( $has_content_class ); ?>">
																				...
																				<?php endif; ?>
																			</deals365-checkbox-accordion-child>
																		<?php endif; ?>
																	<?php endforeach; ?>
																</div>
															<?php endif; ?>
								...
								<?php endif; ?>
							<?php endforeach; ?>
						</deals365-checkbox-accordion-content>
					</deals365-checkbox-accordion>
				<?php endforeach; ?>
			</deals365-filters>
			<div class="col-lg-9 col-md-9 col-sm-12 pb-4">
				<deals365-results-count class="deals365-results-count"></deals365-results-count>
				<deals365-results class="row"></deals365-results>
				<deals365-loading-more class="deals365-loading-more"></deals365-loading-more>
			</div>
		</deals365-search>
	</main>
</div>
