/******/ (() => { // webpackBootstrap
/*!***********************************************!*\
  !*** ./src/blocks/product-hero-block/view.js ***!
  \***********************************************/
...
document.addEventListener('DOMContentLoaded', () => {
  document.querySelectorAll('.wp-block-worthio-product-hero-block[data-gallery], .worthio-product-hero-block [data-gallery]').forEach(initProductHeroGallery);
});
/******/ })()
;
