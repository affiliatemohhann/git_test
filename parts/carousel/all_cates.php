  <?php 
  //  $icon_id = get_field( 'category_icon', 'product_category_' . $term->term_id );
  ...
  <div class="swiper hm-catg-slder">   
    <div class="swiper-wrapper">
      ...
      foreach ($terms as $term): ;
       $icon_id = \WORTHIO_THEME\Inc\Schema_Utils::get_term_value( [ 'category_icon' ], $term->term_id, 'product_category' );
